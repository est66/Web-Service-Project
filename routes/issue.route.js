module.exports = function(app) {
         ...
         * @apiSuccess {Object} issue Return an object of the issue just created
         ...
         *
         * @apiSuccess {Object[]} users Return an array of all issues
         * @apiUse IssueInResponseBody
         * @apiUse Pagination
         *
         ...
         * @apiSuccess {Object} issue Return an object of the issue
         * @apiUse IssueInResponseBody
         ...
         * @apiUse IssueIdInUrlPath
         * @apiUse IssueInRequestBody
         * @apiSuccess {Object} issue Return an object of the user's issue just updated
         * @apiUse IssueInResponseBody
         * @apiUse IssueNotFoundError
         * @apiUse IssueValidationError
         *
 ...
 *         "status": {
 *           "kind": "enum",
 *           "status": "`foo` is not a valid enum value for path `status`.",
 *           "name": "ValidatorError",
 *           "path": "status",
 *           "properties": {
 *             "enumValues": [
